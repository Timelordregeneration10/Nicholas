...
const texture = texloader.load('./image/bubble.jpg');
...
const cameraL = new THREE.PerspectiveCamera(30, widthL / heightL, 10, 3000);
...
document.getElementsByClassName("loading")[0].appendChild(rendererL.domElement);
